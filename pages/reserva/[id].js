        ...
        <section className='container'>
          <div className='row'>
            <div className='col-12'>
              <div className='d-flex align-items-center  mb-4'> <h4 className='me-3'>No. reserva</h4> <span className='reserve__number d-flex align-items-center text-black-600'><i className='fa fa-bookmark text-orange-900' aria-hidden='true' /><div className='ms-2 text-uppercase'>{data?.slug}</div></span> </div>
            </div>
                ...
                <article className='checkout__card--article d-flex flex-column flex-md-row justify-content-center align-items-center'>
                  ...
                  <div className='checkout__card-details text-justify'>
                    ...
                    <p className='mb-0 text-gray-400'>
                      ...
                      {
                        data.finalDate
                        ? format(new Date(data?.finalDate), "dd/MM/yyyy H:mm b", {locales: es })
                        : ''
                      }
                    </p>
                    <p className='mb-0 text-gray-400'>
                  ...
                  <strong className='checkout__card-price text-orange-900 ms-md-auto'>
                    {new Intl.NumberFormat('en-In', {style: 'currency', currency: 'MXN', minimumFractionDigits: 2}).format(data?.totalPrice)}
                  </strong>
                </article>
              </section>
            </div>
