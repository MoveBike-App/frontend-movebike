        ...
        <section className="container">
          <div className="row">
            <div className="col-12">
              <div className="d-flex align-items-center  mb-4"> <h4 className="me-3">No. reserva</h4> <span className="reserve__number text-black-600"><i className="fa fa-bookmark text-orange-900" aria-hidden="true"></i> #59896646555555555556</span> </div>
            </div>
            ...
            <div className="col-lg-5 mt-5 mt-lg-2">
              <section className="">
                ...
                <div className="reserve__tracking steps mx-auto d-flex flex-column flex-md-row justify-content-between align-items-center">
                  ...
                  <div className="round-step round-step--border d-flex justify-content-center align-items-center"></div>
                  <div className="conector conector--disabled"></div>
                  <div className="round-step round-step--disabled d-flex justify-content-center align-items-center"></div>
                  <div className="conector conector--disabled"></div>
                  <div className="round-step round-step--disabled d-flex justify-content-center align-items-center"></div>
                </div>
              </section>
