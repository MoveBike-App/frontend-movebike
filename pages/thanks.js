...
export default function Thanks () {
  ...
  const getPaymentIntent = async () => {
    ...
    try {
      ...
      const monto = dataJson.charge_data[0].amount / 100
      const formatMonto = new Intl.NumberFormat('en-In', { style: 'currency', currency: 'MXN', minimumFractionDigits: 2 }).format(monto)
